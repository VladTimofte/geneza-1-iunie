        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2 sm:gap-3">
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-3 py-2 sm:px-4 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700 font-medium transition-colors text-center"
            >
              + Adaugă
            </button>
            <button
              onClick={handleLogout}
              className="px-3 py-2 sm:px-4 text-slate-500 hover:text-slate-700 text-sm transition-colors border border-slate-200 rounded-lg sm:border-0"
            >
